...
if __name__ == "__main__":
    ...
    temp_path = os.path.join(
        os.getenv("RUNNER_TEMP", os.path.abspath("./temp")), "style_check"
    )
    ...
    subprocess.check_output(
        f"docker run -u $(id -u ${{USER}}):$(id -g ${{USER}}) --cap-add=SYS_PTRACE --volume={repo_path}:/ClickHouse --volume={temp_path}:/test_output {docker_image}",
        shell=True,
    )
