    ...
    with Pool(20) as pool:
        ...
        try:
            ...
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictGetOrDefault_granted_directly,
                    setup=instrument_clickhouse_server_log,
                ),
            )
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictGetOrDefault_granted_via_role,
                    setup=instrument_clickhouse_server_log,
                ),
            )
            run_scenario(
            ...
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictGetHierarchy_granted_directly,
                    setup=instrument_clickhouse_server_log,
                ),
            )
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictGetHierarchy_granted_via_role,
                    setup=instrument_clickhouse_server_log,
                ),
            )
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictIsIn_granted_directly,
                    setup=instrument_clickhouse_server_log,
                ),
            )
            run_scenario(
                ...
                tasks,
                Suite(
                    test=dictIsIn_granted_via_role,
                    setup=instrument_clickhouse_server_log,
                ),
            )
