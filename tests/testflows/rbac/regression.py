...
xfails = {
    ...
    "privileges/system merges/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system ttl merges/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system moves/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system sends/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system fetches/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system restart replica/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
    "privileges/system replication queues/:/:/:/:/SYSTEM:": [(Fail, issue_18206)],
...
def regression(self, local, clickhouse_binary_path, stress=None, parallel=None):
    ...
    with Cluster(
        ...
        nodes=nodes,
        docker_compose_project_dir=os.path.join(current_dir(), "rbac_env"),
    ) as cluster:
